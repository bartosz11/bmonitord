...
public class EmailService {
    ...
    public void sendNotification(Monitor monitor, ContactList contactList, Incident incident) {
        ...
        if (monitor.getLastStatus()== MonitorStatus.UP) {
            ...
            messageText = messageText.replaceFirst("%timestamp%", Instant.ofEpochSecond(incident.getEndTimestamp()).toString());
            ...
            messageText = messageText.replaceFirst("%timestamp%", Instant.ofEpochSecond(incident.getStartTimestamp()).toString());
        }
