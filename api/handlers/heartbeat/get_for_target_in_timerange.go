...
// HandleGetHeartbeatsForTargetInTimeRange docs
...
// @Accept json
// @Produce json
// @Param id path uint true "ID of target to get the list of heartbeats for"
...
// @Success 200 {object} getManyHeartbeatsSuccessResponse
// @Failure 400 {object} helpers.GenericErrorResponse "Returned when a parameter couldn't be parsed."
// @Failure 500 {object} helpers.GenericErrorResponse "Returned when a DB interaction fails."
// @Router /heartbeat/{id}/timerange [get]
func HandleGetHeartbeatsForTargetInTimeRange(db *gorm.DB) gin.HandlerFunc {
...
type getManyHeartbeatsSuccessResponse struct {
