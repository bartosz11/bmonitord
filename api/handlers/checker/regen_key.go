...
// @Failure 400 {object} helpers.GenericErrorResponse "Returned when given ID couldn't be parsed or when given checker is a system checker."
	...
	return func(c *gin.Context) {
		...
		if checker.System {
			resp := helpers.HTTPResponse{
				...
				Error: "system checker's key cannot be regenerated",
			}
			resp.WriteAsJSON(c)
			return
		}
