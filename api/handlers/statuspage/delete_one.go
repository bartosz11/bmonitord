...
// HandleDeleteStatuspageById docs
// @Summary Delete statuspage by ID
// @Description Allows a user to delete a statuspage with specified ID
// @Tags statuspage
// @Security BearerAuth
// @Accept json
// @Produce json
// @Param statuspageId path uint true "ID of statuspage to delete"
...
// @Router /statuspage/{statuspageId} [delete]
func HandleDeleteStatuspageById(db *gorm.DB) gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		if db.Unscoped().Delete(&statuspage).Error != nil {
			helpers.DBInteractionFailed(c)
			return
		}
