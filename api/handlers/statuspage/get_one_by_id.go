...
// HandleGetStatuspageByID docs
// @Summary Get statuspage by ID
// @Description Allows a user retrieve information about statuspage with specified ID.
// @Tags statuspage
// @Security BearerAuth
// @Accept json
// @Produce json
// @Param statuspageID path uint true "ID of statuspage to get"
...
// @Router /statuspage/{statuspageID} [get]
func HandleGetStatuspageByID(db *gorm.DB) gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		err = db.First(&statuspage, "id = ? and user_id = ?", id, user.ID).Error
...
type getStatuspageSuccessResponse struct {
